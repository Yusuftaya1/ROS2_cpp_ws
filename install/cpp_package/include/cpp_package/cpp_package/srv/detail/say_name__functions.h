...
#ifndef CPP_PACKAGE__SRV__DETAIL__SAY_NAME__FUNCTIONS_H_
#define CPP_PACKAGE__SRV__DETAIL__SAY_NAME__FUNCTIONS_H_
...
/// Initialize srv/SayName message.
/**
...
/// Create srv/SayName message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cpp_package__srv__SayName_Request__init().
...
/// Destroy srv/SayName message.
/**
 * It calls
 * cpp_package__srv__SayName_Request__fini()
...
/// Check for srv/SayName message equality.
/**
...
/// Initialize array of srv/SayName messages.
/**
...
/// Finalize array of srv/SayName messages.
/**
 * It calls
 * cpp_package__srv__SayName_Request__fini()
...
/// Create array of srv/SayName messages.
/**
 * It allocates the memory for the array and calls
 * cpp_package__srv__SayName_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SayName messages.
/**
 * It calls
 * cpp_package__srv__SayName_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SayName message array equality.
/**
...
/// Copy an array of srv/SayName messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * cpp_package__srv__SayName_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_package
...
/**
 * It calls
 * cpp_package__srv__SayName_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_package
...
/**
 * It allocates the memory for the array and calls
 * cpp_package__srv__SayName_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_cpp_package
...
/**
 * It calls
 * cpp_package__srv__SayName_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CPP_PACKAGE__SRV__DETAIL__SAY_NAME__FUNCTIONS_H_
